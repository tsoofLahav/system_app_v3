...
from services.agent.runner import _update_file
...
@patch("services.agent.runner.apply_object_updates", return_value=[])
@patch("services.agent.runner.save_file_version")
@patch("services.agent.runner.db.session")
@patch("services.agent.runner.ObjectEmbed")
