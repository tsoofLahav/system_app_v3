-- Paste into Render psql (or: \i path/to/this/file)
-- Updates agent_configs.system_prompt for workspace 1 (default row).

UPDATE agent_configs
SET system_prompt = $PROMPT_BODY$
...
SELECT id, workspace_id, name, length(system_prompt) AS prompt_chars, updated_at
FROM agent_configs
