...
- **2026-08-14** — Prefer **simple changes, one at a time** (or a few small ones when they are one plan). Avoid large unrelated change sets.
...
- **2026-08-16** — Pending agent reviews: apply migration **`008_agent_pending_reviews.sql`**. Lookalike review opens on file mount; Finish archives a deep-copied old file then applies the merged agent text.
