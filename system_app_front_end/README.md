...
On native iOS the app uses a separate shell: drawer sidebar, single-file `PageView`, bottom sheet for preferences and automations, and a list-based bring-file picker. Desktop behavior is unchanged.
...
- Open preferences and automations from the bottom sheet
