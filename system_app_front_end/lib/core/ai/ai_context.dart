...
enum AiSourceType { selection, paragraph, task, checklist }
...
abstract final class AiContextResolver {
  static ResolvedAiContext? resolve({
    ...
    required String? lastChecklistItem,
    required int? lastTaskFileId,
    required int? lastChecklistBlockId,
    required int? lastChecklistFileId,
  }) {
    ...
    if (lastChecklistItem != null && lastChecklistItem.trim().isNotEmpty) {
      return ResolvedAiContext(
        text: lastChecklistItem.trim(),
        sourceType: AiSourceType.checklist,
        topicId: topicId,
        fileId: lastChecklistFileId,
        blockId: lastChecklistBlockId,
      );
    }
