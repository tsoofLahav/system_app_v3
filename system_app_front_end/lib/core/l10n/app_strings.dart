...
class AppStrings {
  ...
  static const _uiEn = {
    ...
    'moveFileToTopic': 'Move to topic',
    'duplicateFile': 'Duplicate file',
    'duplicateFileDone': 'File duplicated',
    ...
    'aiMoveFileToTopic': 'Move file to topic',
    'aiNoFileContext': 'Focus a file to use this action',
    'aiReview': 'Review',
    ...
    'partReviewComplete': 'Part review complete',
    'continueToNextPart': 'Continue to next part',
    'reviewPartCreate': 'New part',
    'reviewPartUpdate': 'Update part',
    'reviewPartRemove': 'Remove part',
    'reviewApproveNewSection': 'Add this section?',
    'reviewConfirmRemoveSection': 'Remove this section?',
    'reviewNewContentLabel': 'Proposed content',
    'reviewRemoveContentLabel': 'Will be removed',
    'acceptAllInSection': 'Accept all in section',
    ...
    'projectUpdateSkippedNoHeaders':
        'Daily log has no part headers. Add inner headers (one section per part) to run project update.',
  ...
  static const _uiHe = {
    ...
    'moveFileToTopic': 'העבר לנושא',
    'duplicateFile': 'שכפל קובץ',
    'duplicateFileDone': 'הקובץ שוכפל',
    ...
    'aiImage': 'צור תמונה',
    'aiGraph': 'צור גרף',
    'aiMoveFileToTopic': 'העבר קובץ לנושא',
    'aiNoFileContext': 'מקם את הסמן בקובץ כדי להשתמש בפעולה זו',
    'aiReview': 'סקירה',
    ...
    'partReviewComplete': 'סקירת החלק הושלמה',
    'continueToNextPart': 'המשך לחלק הבא',
    'reviewPartCreate': 'חלק חדש',
    'reviewPartUpdate': 'עדכון חלק',
    'reviewPartRemove': 'הסרת חלק',
    'reviewApproveNewSection': 'להוסיף את המדור הזה?',
    'reviewConfirmRemoveSection': 'להסיר את המדור הזה?',
    'reviewNewContentLabel': 'תוכן מוצע',
    'reviewRemoveContentLabel': 'יוסר',
    'acceptAllInSection': 'אשר הכל במדור',
    'applySuggestion': 'החל',
    ...
    'projectUpdateSkippedNoHeaders':
        'ביומן אין כותרות חלקים. הוסף כותרות פנימיות (סעיף לכל חלק) כדי להפעיל עדכון פרויקט.',
