...
class BlockContextMenu {
  ...
  static Future<String?> show({
    ...
    try {
      ...
      if (value.startsWith('text:') && value != 'text:emoji') {
        await runBlockTextAction(value);
      } else if (value != 'text:emoji') {
  ...
  static Future<void> handleTextMenuValue(
